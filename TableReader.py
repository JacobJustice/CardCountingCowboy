...
train_ranks = Cards.load_ranks( path + '/card_detector/Card_Imgs/')
train_suits = Cards.load_suits( path + '/card_detector/Card_Imgs/')
print(train_ranks,train_suits)

def get_table_state(videostream):
    cards = []
...
while True:
    cards = get_table_state(videostream)
